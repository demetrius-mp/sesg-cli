...
class FormulationParams(Base):
    ...
    n_similar_words_per_word: Mapped[int] = mapped_column(Integer())
    ...
    __table_args__ = (
        UniqueConstraint("n_words_per_topic", "n_similar_words_per_word"),
    )
    ...
    def get_or_save(
        ...
        stmt = (
            ...
            .where(
                FormulationParams.n_similar_words_per_word == n_similar_words_per_word
            )
        )
    ...
    def get_or_save_from_params_product(
        ...
        n_similar_words_per_word_list: list[int],
        session: Session,
        ...
        return [
            ...
            for n_words_per_topic, n_similar_words_per_word in product(
                n_words_per_topic_list,
                n_similar_words_per_word_list,
            )
        ]
